...
DIM integer player.x=32*3
DIM integer player.y=32*3
...
data 17,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35
...
playermapx = ((player.x + 16 /2)/32)-2
playermapy = ((player.y + 32)/32)-3
playerindex = MAPData(playermapx,playermapy)
checkcollision
checkjump
print @(0,400),playermapx,playermapy,playerindex
box player.x,player.y+32,32,32,,rgb(red)
pause 50
page copy 1 to 0,b
