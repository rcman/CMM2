...
moveplayer
'checkjump
print @(0,400), playermapx,playermapy
...
if player.faceright=1 then
      playermapx1 = ((player.x + PLAYERWIDTH)/2)/TILEWIDTH   
      playermapy1 = ((player.y+TILEHEIGHT)/32)
      playerindex1 = MAPData(playermapy,playermapx)
       if playerindex1 <> 35 then
            'player.x=(playermapx+1) *TILEWIDTH
           player.velx=0
      print @(0,500),playermapy1,playermapx1,playerindex1
